  ...
  return (
    <div className='mt-4 w-100 '>
      <div className='d-flex flex-column align-items-center justify-content-center text-center w-100 '>
        <ParagraphTag text="PRODUCT PREVIEW" />
        <h1 className='fw-bold text-dark'>Your entire pipeline, beautifully organized</h1>
        <ParagraphTag text="Everything need - contacts, meetings, profiles - in one found workspace"
        ...
        <div className="d-flex gap-3 flex-wrap">
          <ParagraphTag text="⚡ avg. 3s entry time" showDot={false} textColor="text-secondary" />
          <ParagraphTag text="📊 profile scoring" showDot={false} textColor="text-secondary" />
